...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','ti.draggable.js')
	if not os.path.exists(js_file):
		js_file = os.path.join(cwd,'..','assets','ti.draggable.example.js')
...
""" % module_assets
	...
	assets_router = os.path.join(cwd,'Classes','TiDraggableModuleAssets.m')
